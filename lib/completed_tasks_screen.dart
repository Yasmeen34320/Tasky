...
class _CompletedTasksScreenState extends State<CompletedTasksScreen> {
  ...
  //     setState(() {
  //       completedTasks.removeWhere((test) => test.id == id);
  //     });
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return ContainerShared(
                        ...
                        onChanged: (value, id) async {
                          ...
                          // int index = completedTasks.indexOf(
                          ...
                          // print(
                          //   'before change ${completedTasks[index!].isDone}',
                          // );
                          // setState(() {
                          //   completedTasks[index!].isDone = value! ? 1 : 0;
                          // });
                          // final allData = PreferencesManager().getString(
                          //   StorageKey.tasks,
                          // );
                          // print(
                          //   'after change ${completedTasks[index].isDone}',
                          // );
